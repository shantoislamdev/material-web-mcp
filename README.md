...
[![CI Status](https://img.shields.io/github/actions/workflow/status/shanroislamdev/material-web-mcp/ci.yml?branch=main&label=CI)](https://github.com/shanroislamdev/material-web-mcp/actions/workflows/ci.yml)
[![codecov](https://img.shields.io/codecov/c/github/shanroislamdev/material-web-mcp)](https://codecov.io/gh/shanroislamdev/material-web-mcp)
[![GitHub issues](https://img.shields.io/github/issues/shanroislamdev/material-web-mcp)](https://github.com/shanroislamdev/material-web-mcp/issues)
...
```bash
git clone https://github.com/shanroislamdev/material-web-mcp.git
cd material-web-mcp
npm install
npm test
npm start
